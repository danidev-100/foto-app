...
func SetupRoutes(
	...
	admin.Get("/courses", catalogHandler.ListCoursesAdmin)
	...
	admin.Get("/divisions", catalogHandler.ListDivisionsAdmin)
	...
	admin.Get("/booklets", catalogHandler.ListBookletsAdmin)
